...
namespace Com.Gridly.Model
{
    ...
    public partial class Cell :  IEquatable<Cell>, IValidatableObject
    {
        ...
        public Cell(string columnId = default(string), DependencyStatusEnum? dependencyStatus = default(DependencyStatusEnum?), int lengthLimit = default(int), int lineLimit = default(int), bool mt = default(bool), bool readOnly = default(bool), List<string> referencedIds = default(List<string>), SourceStatusEnum? sourceStatus = default(SourceStatusEnum?), bool tm = default(bool), Object value = default(Object))
        {
        ...
        public bool Equals(Cell input)
        {
            ...
            return 
                ...
                (
                    this.LineLimit == input.LineLimit ||
                    (this.LineLimit != null &&
                    this.LineLimit.Equals(input.LineLimit))
                ) && 
                (
                    this.Mt == input.Mt ||
                    (this.Mt != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.LineLimit != null)
                    hashCode = hashCode * 59 + this.LineLimit.GetHashCode();
                if (this.Mt != null)
