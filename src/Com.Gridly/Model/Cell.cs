...
namespace Com.Gridly.Model
{
    ...
    public partial class Cell :  IEquatable<Cell>, IValidatableObject
    {
        ...
        public Cell(string columnId = default(string), DependencyStatusEnum? dependencyStatus = default(DependencyStatusEnum?), int lengthLimit = default(int), List<string> referencedIds = default(List<string>), SourceStatusEnum? sourceStatus = default(SourceStatusEnum?), bool tm = default(bool), Object value = default(Object))
        {
